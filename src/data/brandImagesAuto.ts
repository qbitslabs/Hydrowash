...
const brandLinks: Record<string, string> = {
  ...
  'UltrashieldX.webp': 'https://ultrashieldx.com/',
  'Clearpro.webp': 'https://www.clearpro.com/',
  'Garware.webp': 'https://www.garwareppf.com/',
};
...
const allBrands: BrandImage[] = [
  { name: 'Garware', file: 'Garware.webp', url: '/brands/Garware.webp', link: brandLinks['Garware.webp'] },
  ...
  { name: 'Clearpro', file: 'Clearpro.webp', url: '/brands/Clearpro.webp', link: brandLinks['Clearpro.webp'] },
  { name: 'UltrashieldX', file: 'UltrashieldX.webp', url: '/brands/UltrashieldX.webp', link: brandLinks['UltrashieldX.webp'] },
